...
export function renderHome(book: Book, assets: Assets): string {
  ...
  return shell({
    title: `${book.title} — an interactive C++ book`,
    description:
      'An interactive C++ textbook: runnable examples, memory diagrams, and auto-graded practice problems, from first program to templates and concurrency.',
    main,
    book,
    assets,
    bodyClass: 'is-home',
...
export function renderPractice(book: Book, assets: Assets): string {
  ...
  return shell({
    ...
    description: 'Auto-graded C++ practice problems, filterable by topic and difficulty.',
    main,
    book,
    assets,
  });
...
export function renderExercisePage(book: Book, exercise: Exercise, assets: Assets): string {
  ...
  return shell({
    ...
    description: `C++ practice problem: ${exercise.title}`,
    main,
    book,
    assets,
  });
