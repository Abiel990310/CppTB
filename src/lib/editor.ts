import { highlightCpp } from './highlight.ts';
 ...
 * C++ in a browser tolerable — real tabs, indent preservation, bracket
...
export class CodeEditor {
  ...
  constructor(initial: string, options: { minRows?: number } = {}) {
    ...
    this.textarea.setAttribute('aria-label', 'C++ source code');
  ...
  private sync(): void {
    ...
    this.highlightLayer.innerHTML = `${highlightCpp(text)}\n`;
